            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        ...
                        <p class="lead text-center mb-4">Whether you're a business or an individual, 14-day trial no
                            ...
                            <div class="col-auto">
                                <nav class="nav btn-group">
                                    <a href="#monthly" class="btn btn-outline-primary active" data-toggle="tab">Monthly
                                        billing</a>
                                    <a href="#annual" class="btn btn-outline-primary" data-toggle="tab">Annual
                                        billing</a>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-4 mb-3 mb-md-0">
                                        <div class="card text-center">
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="mt-auto">
                                                    <a href="#" class="btn btn-lg btn-outline-primary">Coming soon
                                                        ..</a>
                                                </div>
                                            </div>
                                        </div><!-- /.card -->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-md-5 mr-auto">
                        <p class="lead text-dark">
                            Robust is a theme built with Bootstrap 4, the popular UI framework. The theme is responsive
                            and can be used for any type of web app.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-dark text-left">
                                    With mobile, tablet &amp; desktop support it doesn't matter what device you're
                                    using. Robust is responsive in all browsers.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-dark text-left">
                                    You don't need to be an expert to customize Robust. Our code is very readable and
                                    well documented.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-dark text-left">
                                    Robust is supported by specialists who provide quick and effective support. Usually
                    ...
                    <div class="col-md-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-dark text-left">
                                    Robust works perfectly with: Chrome, Firefox, Safari, Opera and IE 10+. We're
                    ...
                    <div class="col-md-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-dark text-left">
                                    We strictly followed Bootstrap's guidelines to make your integration as easy as
                                    possible. All code is handwritten.
                                </p>
                            </div>
                        </div>
                    </div>
